[![Run App](https://github.com/Vyn3153/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Vyn3153/GithubActions/actions/workflows/run-app.yaml)
